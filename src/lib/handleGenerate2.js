...
const handleGeneratePDF2 = async (formData, carViewImages ,formId) => {
  ...
  try {
    ...
    // Convert to Blob for further processing or uploading
...
export default handleGeneratePDF2;
